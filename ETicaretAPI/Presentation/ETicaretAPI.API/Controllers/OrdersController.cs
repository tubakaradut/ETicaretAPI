...
namespace ETicaretAPI.API.Controllers
{
    ...
    public class OrdersController : ControllerBase
    {
        ...
        public async Task<ActionResult> GetAllOrders(GetAllOrdersQueryRequest getAllOrdersQueryRequest)
        {
        ...
        [AuthorizeDefinition(Menu = AuthorizeDefinitionConstant.Orders, ActionType = ActionType.Updating, Definition = "Complete Order")]
