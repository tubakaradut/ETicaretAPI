...
namespace ETicaretAPI.Persistence.Migrations
{
    ...
    [Migration("20230220220932_mig10")]
    partial class mig10
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ETicaretAPI.Domain.Entities.Identiy.AppRole", b =>
                {
            ...
            modelBuilder.Entity("ETicaretAPI.Domain.Entities.Identiy.AppUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("ETicaretAPI.Domain.Entities.Menuu", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("AppRoleEndpoint", b =>
                {
                    b.HasOne("ETicaretAPI.Domain.Entities.Identiy.AppRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("ETicaretAPI.Domain.Entities.Basket", b =>
                {
                    b.HasOne("ETicaretAPI.Domain.Entities.Identiy.AppUser", "AppUser")
                        .WithMany("Baskets")
            ...
            modelBuilder.Entity("ETicaretAPI.Domain.Entities.Endpoint", b =>
                {
                    b.HasOne("ETicaretAPI.Domain.Entities.Menuu", "Menuu")
                        .WithMany("Endpoints")
                        .HasForeignKey("MenuuId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("ETicaretAPI.Domain.Entities.Identiy.AppUser", null)
                        .WithMany()
